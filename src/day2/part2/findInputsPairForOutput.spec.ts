...
test('Given the output 19690720, should find the pair of inputs that gave this output', () => {
  ...
  expect(findInputsPairForOutput(asInt(19690720))(intCodeProgram)).toEqual(
    some([86, 9])
  )
})
