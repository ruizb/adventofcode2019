import { PanelWires, WirePathStep } from '../domain'
import computeIntersectionFewestSteps from './computeIntersectionFewestSteps'

test('Given the first example, fewest combined steps to reach an intersection should be 30', () => {
  const panelWires: PanelWires = [
    ['R8', 'U5', 'L5', 'D3'] as WirePathStep[],
    ['U7', 'R6', 'D4', 'L4'] as WirePathStep[]
  ]
  expect(computeIntersectionFewestSteps(panelWires)).toBe(30)
})

test('Given the second example, fewest combined steps to reach an intersection should be 610', () => {
  const panelWires: PanelWires = [
    [
      'R75',
      'D30',
    ...
    ['U62', 'R66', 'U55', 'R34', 'D71', 'R55', 'D58', 'R83'] as WirePathStep[]
  ]
  expect(computeIntersectionFewestSteps(panelWires)).toBe(610)
})

test('Given the second example, fewest combined steps to reach an intersection should be 410', () => {
  const panelWires: PanelWires = [
    [
      'R98',
      'U47',
