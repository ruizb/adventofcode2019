...
test('Given the first example, shortest Manhattan distance should be 6', () => {
  const panelWires: PanelWires = [
    ['R8', 'U5', 'L5', 'D3'] as WirePathStep[],
    ['U7', 'R6', 'D4', 'L4'] as WirePathStep[]
  ]
  expect(findShortestManhattanDistance(panelWires)).toBe(6)
})

test('Given the second example, shortest Manhattan distance should be 159', () => {
  const panelWires: PanelWires = [
    [
      'R75',
      'D30',
  ...
  expect(findShortestManhattanDistance(panelWires)).toBe(159)
})

test('Given the third example, shortest Manhattan distance should be 135', () => {
  const panelWires: PanelWires = [
    [
      'R98',
      'U47',
  ...
  expect(findShortestManhattanDistance(panelWires)).toBe(135)
})

test('Given all the inputs from part 1, shortest Manhattan distance should be 446', () => {
  ...
  expect(findShortestManhattanDistance(panelWires)).toBe(446)
})
